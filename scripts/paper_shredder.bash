...
papermill notebooks/base/joint_multitask_learning.ipynb notebooks/mistral/joint_multitask_learning.ipynb -p model_path mistralai/Mistral-7B-v0.1 -p train_epochs $train_epochs -p eval_epochs $eval_epochs -p logging_steps $logging_steps -k sh_finetune
...
papermill notebooks/base/text_classification.ipynb notebooks/mistral/text_classification_linear_probe.ipynb -p model_path mistralai/Mistral-7B-v0.1 -p train_epochs $train_epochs -p eval_epochs $eval_epochs -p logging_steps $logging_steps -p full_finetune False -p num_heads 6 -k sh_finetune
papermill notebooks/base/text_classification_qlora.ipynb notebooks/mistral/text_classification_qlora.ipynb -p model_path mistralai/Mistral-7B-v0.1 -p train_epochs $train_epochs -p eval_epochs $eval_epochs -p logging_steps $logging_steps -k sh_finetune
...
papermill notebooks/base/joint_multitask_learning.ipynb notebooks/llama/joint_multitask_learning.ipynb -p model_path meta-llama/Llama-2-7b-hf -p train_epochs $train_epochs -p eval_epochs $eval_epochs -p logging_steps $logging_steps -k sh_finetune
...
papermill notebooks/base/text_classification.ipynb notebooks/llama/text_classification_linear_probe.ipynb -p model_path meta-llama/Llama-2-7b-hf -p train_epochs $train_epochs -p eval_epochs $eval_epochs -p logging_steps $logging_steps -p full_finetune False -p num_heads 6 -k sh_finetune
papermill notebooks/base/text_classification_qlora.ipynb notebooks/llama/text_classification_qlora.ipynb -p model_path meta-llama/Llama-2-7b-hf -p train_epochs $train_epochs -p eval_epochs $eval_epochs -p logging_steps $logging_steps -k sh_finetune
